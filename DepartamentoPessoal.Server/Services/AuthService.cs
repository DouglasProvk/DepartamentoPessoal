...
public class AuthService(AppDbContext db, IConfiguration config) : IAuthService
{
    public async Task<LoginOutput?> LoginAsync(LoginInput input)
    {
        ...
        var token = GerarToken(usuario.Id, usuario.Nome, usuario.Email, usuario.Perfil.ToString(), expiracao);
    ...
    private string GerarToken(int id, string nome, string email, string perfil, DateTime expiracao)
    {
